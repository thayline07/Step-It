export const lightTheme = {
  colors: {
    ...
    perfil: {
      titulo: "#1F86E0",
      card: ["rgba(60, 158, 104, 0.05)", "rgba(163, 220, 188, 0.05)"],
      link: "#10A3FF",
    },
    relatorios: {
      card: ["transparent", "transparent"],
      card_grafico: ["rgba(46, 167, 255, 0.2)", "rgba(255, 255, 255, 0.2)"],
      linha_grafico: "#17B9FF",
      borda: "#fff",
      cor_grafico: "linear-gradient(to bottom, #17B9FF, transparent)",
      borda_grafico: ["#17B9FF", "rgba(23, 185, 255, 0.2)"],
      icones: "#000",
      botao: "#62aaea",
      background_icone_relatorio: "#0D2B48",
      background_icone_voltar: [
        "rgba(98, 170, 234, 0.23)",
        "rgba(98, 170, 234, 0.23)",
      ],
...
export const darkTheme = {
  colors: {
    ...
    perfil: {
      titulo: "#1F86E0",
      card: ["rgba(60, 158, 104, 0.05)", "rgba(163, 220, 188, 0.01)"],
      link: "#10A3FF",
    },
    relatorios: {
      card: ["#17B9FF", "transparent"],
      card_grafico: ["rgba(23, 185, 255, 0.2)", "transparent"],
      linha_grafico: "#17B9FF",
      borda: "#fff",
      cor_grafico: ["#17B9FF", "transparent"],
      borda_grafico: ["#17B9FF", "rgba(23, 185, 255, 0.2)"],
      icones: "#fff",
      botao: "#020202ab",
      background_icone_relatorio: "rgba(98, 170, 234, 0.23)",
      background_icone_voltar: ["rgba(23, 185, 255, 0.2)", "transparent"],
